...
| [BufferUsage](xref:Veldrid.BufferUsage) | None | OpenGL buffers can always be used as any type of buffer -- there is no specialiazation. |
| [Texture](xref:Veldrid.Texture) | [Texture objects](https://www.khronos.org/opengl/wiki/Texture) | |
| [TextureUsage](xref:Veldrid.TextureUsage) | None | OpenGL textures can always be used as any type of texture -- there is no specialiazation. |
